...
for order in range(2, 21):
    ...
    with open("{}_b60kv_s_{}g_m.sh".format(lang,order), 'w') as f:
        print("export TRAIN_NAME='{}_b60kv_s_{}g_m'".format(lang,order), file=f)
        print("export TRAIN_DIR=$GROUP_DIR/p/sami/lmmodels/biglm/$TRAIN_NAME", file=f)
        print(file=f)
        print("export SOURCE_FILES=$GROUP_DIR/p/sami/lmdata/{}/biglm.txt".format(lang), file=f)
        print(file=f)
    ...
    with open("{}_b60kv_s_{}g_w.sh".format(lang,order), 'w') as f:
        print("export TRAIN_NAME='{}_b60kv_s_{}g_w'".format(lang,order), file=f)
        print("export TRAIN_DIR=$GROUP_DIR/p/sami/lmmodels/biglm/$TRAIN_NAME", file=f)
        print(file=f)
        print("export SOURCE_FILES=$GROUP_DIR/p/sami/lmdata/{}/biglm.txt".format(lang), file=f)
        print(file=f)
