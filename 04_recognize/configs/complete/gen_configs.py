            ...
            for order in range(5,9):
                for type in ("m", "w"):
                    with open("{}{}_co_{}_{}g_{}.sh".format(lang,gender,tool,order,type), 'w') as f:
                        print("export TEST_NAME='{}{}_co_{}_{}g_{}'".format(lang,gender,tool,order,type), file=f)
                        print("export TEST_DIR=$GROUP_DIR/p/sami/recog_tests/complete/", file=f)
                        print(file=f)
                        ...
                        print("export TEST_LM=$GROUP_DIR/p/sami/lmmodels/complete_wikipedia/{}{}_co_{}_{}g_{}".format(lang,gender,tool,order,type), file=f)
